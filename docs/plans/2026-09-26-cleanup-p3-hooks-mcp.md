# Cleanup P3 -- finish packages: internal/hooks, internal/mcp
...
- `internal/hooks` (616 non-test lines, 765 test lines)
- `internal/mcp` (892 non-test lines, 1116 test lines)
...
7. `make check` (foreground) passes -- lint, comments, file size and coverage
   guard included.
8. Copy this plan to `docs/plans/2026-09-26-cleanup-p3-hooks-mcp.md`; commit once.
