# Cleanup P3 -- finish packages: internal/ingest, internal/usage
...
- `internal/ingest` (1980 non-test lines, 2849 test lines)
- `internal/usage` (1650 non-test lines, 1424 test lines)
...
7. `make check` (foreground) passes -- lint, comments, file size and coverage
   guard included.
8. Copy this plan to `docs/plans/2026-09-26-cleanup-p3-ingest-usage.md`; commit once.
