# Cleanup P3 -- finish packages: internal/planner, internal/policy
...
- `internal/planner` (1751 non-test lines, 2216 test lines)
- `internal/policy` (782 non-test lines, 1261 test lines)
...
7. `make check` (foreground) passes -- lint, comments, file size and coverage
   guard included.
8. Copy this plan to `docs/plans/2026-09-26-cleanup-p3-planner-policy.md`; commit once.
