# Cleanup P3 -- finish packages: internal/doctor
...
- `internal/doctor` (2446 non-test lines, 3148 test lines)
...
7. `make check` (foreground) passes -- lint, comments, file size and coverage
   guard included.
8. Copy this plan to `docs/plans/2026-09-26-cleanup-p3-doctor.md`; commit once.
