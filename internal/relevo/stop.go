...
// local stop and " on <server>" for a remote one, haveReport says whether
// a report file was on disk, and clause is the artifact clause closeClause
// resolved for the close's binding. Pure.
