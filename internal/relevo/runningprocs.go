...
// reads; cmd/relevo converts the tuples to doctor.RunningProc, so neither
// internal/relevo nor internal/doctor imports the other.
...
//
// A pane builder and an adopted endpoint are deliberately absent: relevo did not
