...
claude pin is deliberately above its builder's; this opencode pin matches the
`builder` alias. Change it to whatever your provider offers, or delete the
line to inherit the caller's model.
