...
func setConsultStatus(f *fakePanes, status string) {
...
func reconcileOnce(t *testing.T, rt Runtime, f *fakePanes, state store.State) store.Binding {
	t.Helper()
