...
// SessionLocator finds a harness's own session record for an endpoint,
...
// refused (ok false) -- it is used in a path.
...
// round's stream announced one. Every other binding answers nil -- never
// guessed.
